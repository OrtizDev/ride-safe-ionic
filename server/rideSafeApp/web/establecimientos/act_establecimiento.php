...
<head>
    ...
    <title>Radar Biker | Actualización de Establecimiento </title>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="green">
                                    <h4 class="title">Añadir Pueblo M&aacutegico</h4>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="number" class="form-control" name="id_municipio" required="Este campo es requerido" value="<?php echo $data['id_municipio'] ?>"/>
                                                </div>
                                            </div>
                                        </div>
