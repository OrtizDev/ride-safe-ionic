...
<head>
	...
	<title>Ride Safe | Alta Marca</title>
	                    ...
	                    <div class="col-md-12">
	                        <div class="card">
	                            <div class="card-header" data-background-color="blue">
	                                <h4 class="title">Añadir Marca de Motocicleta</h4>
									<p class="category">Completa la siguiente informaci&oacuten de la Marca de Motocicleta</p>
	                            </div>
	                            <div class="card-content">
	                                <form action="insert.php" method="post" >
	                                    ...
	                                    <button type="submit" name="enviar" class="btn btn-info pull-right">Registrar Ruta</button>
